...
static const char *generate_game_file_msg(size_t idx, uint64_t *user_numbers, uint64_t *winning_numbers) {
    ...
    char *game_msg = (char*)malloc(sizeof(char) * 4096 * 2);
              sprintf(game_msg,
                      ...
                      winning_numbers[4], winning_numbers[5], idx, prize2string(prize),
                      balance(prize));
    return (const char*)game_msg;
}
